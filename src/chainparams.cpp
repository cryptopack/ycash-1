...
public:
    CMainParams() {
        ...
        consensus.geneisPowLimit = uint256S("0007ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        ...
        consensus.vUpgrades[Consensus::UPGRADE_YCASH].nActivationHeight = 556672;
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("07ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.geneisPowLimit = consensus.powLimit;
        consensus.nPowAveragingWindow = 17;
        assert(maxUint/UintToArith256(consensus.powLimit) >= consensus.nPowAveragingWindow);
        consensus.nPowMaxAdjustDown = 32; // 32% adjustment down
        consensus.nPowMaxAdjustUp = 16; // 16% adjustment up
